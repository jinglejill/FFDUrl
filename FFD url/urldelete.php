<?php
    ...
    if ($result=mysqli_query($con,$sql))
    {
        ...
        $code .= tab() . '$sql = "select * from ' . getTableNameFromPrimaryKey($primaryKey) . ' where ' . $primaryKey . ' = ' . "'" . '$' . makeFirstLetterLowerCase($primaryKey) . "'" . '";<br>';
        ...
        $code .= tab() . '$sql = "delete from ' . getTableNameFromPrimaryKey($primaryKey) . ' where ' . $primaryKey . ' = ' . "'" . '$' . makeFirstLetterLowerCase($primaryKey) . "'" . '";<br>';
