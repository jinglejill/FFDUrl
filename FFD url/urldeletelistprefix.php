<?php
    ...
    if ($result=mysqli_query($con,$sql))
    {
        ...
        $code .= tab() . tab() . '$sql = "select * from ' . getTableNameFromPrimaryKey($primaryKey) . ' where ' . $primaryKey . ' in ' . "('" . '$' . makeFirstLetterLowerCase($primaryKeyWithPrefix) . '[0]' . "'" . '";<br>';
        ...
        $code .= tab() . tab() . tab() . '$sql = "delete from ' . getTableNameFromPrimaryKey($primaryKey) . ' where ' . $primaryKey . ' in ' . "('" . '$' . makeFirstLetterLowerCase($primaryKeyWithPrefix) . '[0]' . "'" . '";<br>';
        $code .= tab() . tab() . tab() . 'for($i=1; $i<$count' . makeFirstLetterUpperCase($prefix) . getTableNameFromPrimaryKey($primaryKey) . '; $i++)<br>';
        $code .= tab() . tab() . tab() . '{<br>';
        $code .= tab() . tab() . tab() . tab() . '$sql .= ",' . "'" . '$' . makeFirstLetterLowerCase($primaryKeyWithPrefix) . '[$i]' . "'" . '";<br>';
        $code .= tab() . tab() . tab() . '}<br>';
        $code .= tab() . tab() . tab() . '$sql .= ")";<br>';
