<?php    
    ...
    //query statement
    $sql = "update MenuType set Name = '$name', AllowDiscount = '$allowDiscount', Color = '$color', OrderNo = '$orderNo', Status = '$status', ModifiedUser = '$modifiedUser', ModifiedDate = '$modifiedDate' where MenuTypeID = '$menuTypeID'";
    $ret = doQueryTask($sql);
    if($ret != "")
    {
        mysqli_rollback($con);
