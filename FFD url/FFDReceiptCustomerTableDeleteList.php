<?php    
    ...
    if($countReceiptCustomerTable > 0)
    {
        ...
        $sql = "select * from ReceiptCustomerTable where ReceiptCustomerTableID in ('$receiptCustomerTableID[0]'";
        ...
        {
            //query statement
            $sql = "delete from ReceiptCustomerTable where ReceiptCustomerTableID in ('$receiptCustomerTableID[0]'";
            for($i=1; $i<$countReceiptCustomerTable; $i++)
            {
                $sql .= ",'$receiptCustomerTableID[$i]'";
            }
