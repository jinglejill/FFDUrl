<?php    
    ...
    $sql = "select * from SubIngredientType where SubIngredientTypeID = '$subIngredientTypeID'";
    $selectedRow = getSelectedRow($sql);
    
    
    
    //query statement
    $sql = "delete from SubIngredientType where SubIngredientTypeID = '$subIngredientTypeID'";
    $ret = doQueryTask($sql);
    if($ret != "")
    {
        mysqli_rollback($con);
