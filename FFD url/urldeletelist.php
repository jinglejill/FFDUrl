<?php
    ...
    if ($result=mysqli_query($con,$sql))
    {
        ...
        $code .= tab() . tab() . '$sql = "select * from ' . getTableNameFromPrimaryKey($primaryKey) . ' where ' . $primaryKey . ' in ' . "('" . '$' . makeFirstLetterLowerCase($primaryKey) . '[0]' . "'" . '";<br>';
        $code .= tab() . tab() . 'for($i=1; $i<$count' . getTableNameFromPrimaryKey($primaryKey) . '; $i++)<br>';
        $code .= tab() . tab() . '{<br>';
        $code .= tab() . tab() . tab() . '$sql .= ",' . "'" . '$' . makeFirstLetterLowerCase($primaryKey) . '[$i]' . "'" . '";<br>';
        $code .= tab() . tab() . '}<br>';
        $code .= tab() . tab() . '$sql .= ")";<br>';
        ...
        $code .= tab() . tab() . tab() . '$sql = "delete from ' . getTableNameFromPrimaryKey($primaryKey) . ' where ' . $primaryKey . ' in ' . "('" . '$' . makeFirstLetterLowerCase($primaryKey) . '[0]' . "'" . '";<br>';
        $code .= tab() . tab() . tab() . 'for($i=1; $i<$count' . getTableNameFromPrimaryKey($primaryKey) . '; $i++)<br>';
        $code .= tab() . tab() . tab() . '{<br>';
        $code .= tab() . tab() . tab() . tab() . '$sql .= ",' . "'" . '$' . makeFirstLetterLowerCase($primaryKey) . '[$i]' . "'" . '";<br>';
        $code .= tab() . tab() . tab() . '}<br>';
