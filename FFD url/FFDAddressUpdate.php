<?php    
    ...
    //query statement
    $sql = "update Address set MemberID = '$memberID', Street = '$street', PostCode = '$postCode', Country = '$country', KeyAddressFlag = '$keyAddressFlag', DeliveryAddressFlag = '$deliveryAddressFlag', TaxAddressFlag = '$taxAddressFlag', DeliveryCustomerName = '$deliveryCustomerName', DeliveryPhoneNo = '$deliveryPhoneNo', TaxCustomerName = '$taxCustomerName', TaxPhoneNo = '$taxPhoneNo', TaxID = '$taxID', ModifiedUser = '$modifiedUser', ModifiedDate = '$modifiedDate' where AddressID = '$addressID'";
    $ret = doQueryTask($sql);
    if($ret != "")
    {
        mysqli_rollback($con);
