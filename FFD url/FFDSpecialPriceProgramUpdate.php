<?php
    ...
    //query statement
    $sql = "update SpecialPriceProgram set MenuID = '$menuID', StartDate = '$startDate', EndDate = '$endDate', SpecialPrice = '$specialPrice', ModifiedUser = '$modifiedUser', ModifiedDate = '$modifiedDate' where SpecialPriceProgramID = '$specialPriceProgramID'";
    $ret = doQueryTask($sql);
    if($ret != "")
    {
        mysqli_rollback($con);
