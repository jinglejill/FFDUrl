<?php    
    ...
    //query statement
    $sql = "update Ingredient set IngredientTypeID = '$ingredientTypeID', SubIngredientTypeID = '$subIngredientTypeID', Name = '$name', Uom = '$uom', UomSmall = '$uomSmall', SmallAmount = '$smallAmount', OrderNo = '$orderNo', Status = '$status', ModifiedUser = '$modifiedUser', ModifiedDate = '$modifiedDate' where IngredientID = '$ingredientID'";
    $ret = doQueryTask($sql);
    if($ret != "")
    {
        mysqli_rollback($con);
