<?php    
    ...
    if($countOrderCancelDiscount > 0)
    {
        ...
        $sql = "select * from OrderCancelDiscount where OrderCancelDiscountID in ('$orderCancelDiscountID[0]'";
        ...
        {
            //query statement
            $sql = "delete from OrderCancelDiscount where OrderCancelDiscountID in ('$orderCancelDiscountID[0]'";
            for($i=1; $i<$countOrderCancelDiscount; $i++)
            {
                $sql .= ",'$orderCancelDiscountID[$i]'";
            }
